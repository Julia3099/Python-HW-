...
def input_data():
    ...
    while var != 1 and var != 2:
        print('Подумаёте ещё. Всего 2 варианта) ')
...
def change_line(dataFile, numberRow, numberFile):
    answer = input(f"Изменить данную запись > {dataFile[numberRow]} ? \nВведите ответ ('да' или 'нет'): ")
    while answer != 'да':
...
def put_data():
    ...
    while number_file != 1 and number_file != 2:
        print('Соберитесь. Всего 2 варианта. ')
        number_file = int(input('Введите номер файла: '))
...
def delete_data():
    ...
    while number_file != 1 and number_file != 2:
        print('Всего 2 варианта. Ещё раз. ')
        number_file = int(input('Введите номер файла: '))
